...
// NOT related to the project; just a demonstration of a function within a function
...
console.log(sumUp(1, 5, 10, "not a number", 6, 10));
console.log(sumUp(1, 5, 10, -3, 6, 10, 25, "string value"));
