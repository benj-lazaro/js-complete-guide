...
// Define a function expression for the closing the deletion modal
...
const startDeleteMovieHandler = (movieId) => {
  ...
  // Deep clone the button -> hack job that removes previous event listeners attached to this object
  // To address the multiple "cancel" clicks before confirming deletion bug
  confirmDeletionButton.replaceWith(confirmDeletionButton.cloneNode(true));
  confirmDeletionButton = deleteMovieModal.querySelector(".btn--danger");

  // Remove previous event listeners; when movie element deletion is cancelled
...
// Define a callback function expression that toggles off the backdrop, modal element & clears input
