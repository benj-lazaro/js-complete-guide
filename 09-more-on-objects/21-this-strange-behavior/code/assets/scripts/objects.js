...
const renderMovies = (filter = "") => {
  ...
  filteredMovie.forEach((movie, index, movies) => {
    ...
    // NOTE: Calling the method "getFormattedTitle" as a stand-alone will reference "this" w/ the global Window object
    let { getFormattedTitle } = movie;

    // Bind the extracted method "getFormattedTitle" w/ the object "movie"
    getFormattedTitle = getFormattedTitle.bind(movie);

    // Calls the method ".getFormattedTitle"
    // NOTE: The "this" keyword currently refers to the object "movie"
