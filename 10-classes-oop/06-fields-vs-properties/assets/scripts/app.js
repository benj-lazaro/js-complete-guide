...
class Product {
  // Moved fields w/in the constructor method as they require initial values after instantiation
  ...
  constructor(title, image, price, desc) {
    // Assign the passed arguments as initial values to the corresponding class fields
    this.title = title;
    this.imageURL = image;
    this.price = price;
