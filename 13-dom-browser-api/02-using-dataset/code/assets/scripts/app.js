...
class ProjectItem {
  ...
  showMoreInfoHandler() {
    // Check if a "ProjectItem" object's tooltip has already been rendered
    if (this.hasActiveTooltip) {
      return;
    }

    // Retrieve a "ProjectItem" object's "data-*" attribute
  ...
  connectSwitchButton(type) {
    ...
    switchBtn.addEventListener(
      "click",
      this.updateProjectListsHandler.bind(null, this.id.bind),
    );
  }
